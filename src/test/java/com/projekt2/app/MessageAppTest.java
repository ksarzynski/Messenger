...
import com.projekt2.messenger.MockMessageService;
...
public class MessageAppTest {
	...
	@Test
	public void InvalidMessageReturnsException() throws MalformedRecipientException {
		assertThrows(MalformedRecipientException.class,
	            ()->{
	            	mockMessageService.setMessageIsSent(true);
	        		assertEquals(SendingStatus.SENDING_ERROR, mockMessageService.send(VALID_SERVER, INVALID_MESSAGE));
	            });
	}
