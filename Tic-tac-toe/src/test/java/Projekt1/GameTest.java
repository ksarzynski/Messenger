...
public class GameTest {
	...
	public void wrongRowPosition1() {
		try {
			...
			assertEquals("Row out of board", expected.getMessage());
		}
	}
	...
	public void wrongColumnPosition1() {
		try {
			...
			assertEquals("Column out of board", expected.getMessage());
		}
	}
	...
	public void positionOccupiedTest() {
		try {
			...
			assertEquals("Position occupied or wrong mark", expected.getMessage());
		}
	}
